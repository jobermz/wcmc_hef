...
public class TemProyectosPoligonosDto implements BaseBeanVectorialDto {
	...
	public Double getDblShCodigo() {
		return dblShCodigo;
	}
	public void setDblShCodigo(Double dblShCodigo) {
		this.dblShCodigo = dblShCodigo;
	}
	public String getStrFcComun() {
		return strFcComun;
	}
	public void setStrFcComun(String strFcComun) {
		this.strFcComun = strFcComun;
	}
	...
	public String getStrInicProg() {
		return strInicProg;
	}
	public void setStrInicProg(String strInicProg) {
		this.strInicProg = strInicProg;
	}
	...
	public String getStrTipoDeDa() {
		return strTipoDeDa;
	}
	public void setStrTipoDeDa(String strTipoDeDa) {
		this.strTipoDeDa = strTipoDeDa;
	}
