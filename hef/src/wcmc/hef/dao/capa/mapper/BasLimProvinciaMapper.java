...
public interface BasLimProvinciaMapper {
	...
	public List<BasLimProvincia> selectByDefaultParameterCombo(BasLimProvinciaParamDef basLimProvinciaParamDef);
	public BasLimProvincia selectByPrimaryKey(BasLimProvinciaKey basLimProvinciaKey);
	public BasLimProvincia selectByPrimaryKeyGeometry(BasLimProvinciaKey basLimProvinciaKey);
