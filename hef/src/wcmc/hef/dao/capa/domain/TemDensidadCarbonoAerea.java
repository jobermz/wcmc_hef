...
public class TemDensidadCarbonoAerea {
	private String strPoligonoConsulta;
	private String strValuePromedio;
	private String strValue;
	private String strCategoria;

	public TemDensidadCarbonoAerea() {
	}
	public TemDensidadCarbonoAerea(String strPoligonoConsulta, String strValuePromedio, String strValue) {
