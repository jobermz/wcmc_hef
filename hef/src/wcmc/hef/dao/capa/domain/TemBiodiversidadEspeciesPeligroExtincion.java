...
public class TemBiodiversidadEspeciesPeligroExtincion {
	private String strPoligonoConsulta;
	private String strValuePromedio;
	private String strValue;
	private String strCategoria;
	
	public TemBiodiversidadEspeciesPeligroExtincion() {
	}
	public TemBiodiversidadEspeciesPeligroExtincion(String strPoligonoConsulta, String strValuePromedio, String strValue) {
