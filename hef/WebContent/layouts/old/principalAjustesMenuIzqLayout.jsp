	...
	<div style="background-color: #384756;max-width: 250px; position: fixed;bottom:0px;left: 0px;height: 100%;vertical-align: bottom;">
		<div class="container-fluid" style="color: white;height: 100%;font-size: 18px;margin-top: 105px;">
			<center>
				...
				<p class="imgHand" onclick="document.location.href='empresa.action';">Empresa</p>
				<p class="imgHand" onclick="document.location.href='claveAcceso.action';">Clave de acceso</p>
				<p class="imgHand" onclick="document.location.href='cuentaUsuario.action';">Cuenta de usuario</p>
				<p class="imgHand" onclick="document.location.href='adjunto.action';">Imagenes</p>
