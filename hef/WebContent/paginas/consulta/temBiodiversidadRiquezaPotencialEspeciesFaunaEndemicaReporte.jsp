...
<table border="0" style="width: 100%;">
	...
	<tr>
		...
		<td>${sessionScope.reporte.beanTemBiodiversidadRiquezaPotencialEspeciesFaunaEndemica.strValueMin}</td>
	</tr>
	<tr>
		<td><strong>Valor m&aacute;ximo</strong></td>
		<td>${sessionScope.reporte.beanTemBiodiversidadRiquezaPotencialEspeciesFaunaEndemica.strValueMax}</td>
	</tr>
	<tr>
